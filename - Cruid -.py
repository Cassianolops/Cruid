...
item_label = tk.Label(root, text= "Digite o email", font= ("arial, 25"), bg="green")
item_label.pack()
item_entry= tk.Entry(root)
item_entry.pack()

btn_creat = tk.Button(root, text="Salvar", command=create)
btn_creat.pack()
...
btn_delete = tk.Button(root, text="Apagar", command=delete1)
btn_delete.pack()
